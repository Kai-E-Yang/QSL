...
for ix in range(50):
	for iy in range(50):
		for iz in range(50):
			...
			r3 = r - c3
			r4 = r - c4
			b1 = 1.*r1/(np.sqrt(r1[0]**2 + r1[1]**2 + r1[2]**2)**3)
			b2 = -1.*r2/(np.sqrt(r2[0]**2 + r2[1]**2 + r2[2]**2)**3)
			b3 = -1.*r3/(np.sqrt(r3[0]**2 + r3[1]**2 + r3[2]**2)**3)
			b4 = -1.*r4/(np.sqrt(r4[0]**2 + r4[1]**2 + r4[2]**2)**3)
			bx[ix,iy,iz] = b1[0] + b2[0] + b3[0] + b4[0]
			by[ix,iy,iz] = b1[1] + b2[1] + b3[1] + b4[1]
			bz[ix,iy,iz] = b1[2] + b2[2] + b3[2] + b4[2]
