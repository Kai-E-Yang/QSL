...
Then the LHS and RHS can be integral separately, lead to $\ln(\sin(\theta_{Rs})/\sin(\theta_{R\odot}))=Const.$, where $Const.=\int_{R_{\odot}}^{Rs}$, by numerical integral, it is 0.266657.
